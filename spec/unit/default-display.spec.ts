  ...
  describe("summary", () => {
    ...
    it("should report pending with incomplete", done => {
      JasmineEnv.execute(
        ...
        (outputs, summary) => {
          expect(summary).contains(
            "Executed 0 of 2 specs INCOMPLETE (2 PENDING) in {time}."
          );
          done();
        }
      );
      ...
      JasmineEnv.execute(
        ...
        (outputs, summary) => {
          expect(summary).toContain(
            "Executed 1 of 2 specs (1 FAILED) (1 PENDING) in {time}."
          );
          done();
        }
      );
    ...
    it("should report skipped with incomplete", done => {
      JasmineEnv.execute(
        ...
        (outputs, summary) => {
          expect(summary).toContain(
            "Executed 1 of 2 specs INCOMPLETE (1 SKIPPED) in {time}."
          );
          done();
        }
      );
    ...
    it("should report ERRORS when afterAll in suite throws", done => {
      JasmineEnv.execute(
        ...
        (outputs, summary) => {
          expect(summary).toContain(
            "Executed 1 of 1 spec (1 ERROR) in {time}."
          );
          done();
        }
      );
    ...
    it("should report ERRORS when afterAll throws", done => {
      JasmineEnv.execute(
        ...
        (outputs, summary) => {
          expect(summary).toContain(
            "Executed 1 of 1 spec (2 ERRORS) in {time}."
          );
          done();
        }
      );
    ...
    it("should report skipped with failure and pending", done => {
      JasmineEnv.execute(
        ...
        (outputs, summary) => {
          expect(summary).toContain(
            "Executed 1 of 4 specs (1 FAILED) (1 PENDING) (2 SKIPPED) in {time}."
          );
          done();
        }
      );
